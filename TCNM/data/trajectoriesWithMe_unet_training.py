...
class TrajectoryDataset(Dataset):
    ...
    def __init__(
        ...
        min_ped=1, delim='\t',other_modal='gph', areas=None,year_filter=[],test_year=None
    ):
        """
        Args:
        ...
        for area in self.areas:
            area_files = os.listdir(os.path.join(self.data_dir['root'],area,self.data_dir['type']))
            area_files = [os.path.join(self.data_dir['root'],area,self.data_dir['type'], _path) for _path in area_files if test_year in _path]
    ...
    def get_img(self,tyid_dic):
        ...
        env_root = r'G:\data\evn_data\all_area_correct_location_includeunder15_2023'
        env_data_obs = {}
        ...
        modal_path = {'gph':r'G:\data\ERA5\all_ocean_gph500_2023',
                      'mcc':'/data/hc/TYDataset/wind_year_MCC_centercrop',
                      '10v':'/data/hc/TYDataset/wind_year_V10_centercrop',
                      '10u':'/data/hc/TYDataset/wind_year_U10_centercrop',
                      'sst':'/data/hc/TYDataset/SST_year_centercrop',
                      '100v': '/data/hc/TYDataset/wind_year_V100_centercrop',
                      '100u': '/data/hc/TYDataset/wind_year_U100_centercrop',
                      }
...
if __name__ == '__main__':
    path = {'root':r'G:\data\all_area_bst\bst_divi10_train_val_test_inlcude15_2023','type':'test'}
    dset = TrajectoryDataset(path,obs_len=8,pred_len=12,skip=1,delim='\t',areas=['EP','NA','NI','SI','SP','WP'],test_year='2018')
